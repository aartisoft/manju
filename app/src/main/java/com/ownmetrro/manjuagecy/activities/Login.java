...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
        ...
        otpLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user_email.getText().toString().equals("")){
                    ...
                    ConstantValues.MOBILENUMBER = user_email.getText().toString();

                    Intent otpIntent = new Intent(getApplicationContext(),OTP.class);
    ...
    private void processLogin() {
        ...
        Call<UserData> call = APIClient.getInstance()
                .processLogin
                        (
                               user_ccode .getText().toString()+ user_email.getText().toString().trim(),
